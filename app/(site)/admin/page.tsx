    ...
    return (
        <main className="pt-14 h-screen bg-primary overflow-y-auto flex flex-col">
            ...
            <div className="bg-sveYellow p-4 flex flex-col space-y-4">
                <Link href="/admin/roster" className="flex items-center justify-between p-2 bg-sveYellowDarker rounded-md font-bold text-xl transition duration-300 hover:scale-[103%]">
                    <Users2 className="ml-2 h-6 w-6" />
                    Manage Roster 
                    <ArrowRight className="mr-2 h-6 w-6" />
                </Link>
                <Link href="/admin/events" className="flex items-center justify-between p-2 bg-sveYellowDarker rounded-md font-bold text-xl transition duration-300 hover:scale-[103%]">
